...
public class ThrownExceptionFinderVisitor extends ASTVisitor {
	 ...
	 * @param scope
	 */
	public void processThrownExceptions(TryStatement statement, BlockScope scope) {
		...
		removeCaughtExceptions(statement, true /*remove unchecked exceptions this time*/);
	}
	 ...
	 * {@link ThrownExceptionFinderVisitor#processThrownExceptions(TryStatement, BlockScope)}
	 ...
	 * {@link ThrownExceptionFinderVisitor#getDiscouragedExceptions()}.
	 */
